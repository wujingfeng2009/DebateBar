...
Meteor.methods({
    postInsert: function(postAttributes) {
        ...
        if (postAttributes.postType === 0) { /* for topics */
            ...
            if (errors.proposition || errors.positive || errors.negative)
                throw new Meteor.Error('invalid-post', "you should write proposition, positive and negative standpoints for your debate!");
            ...
            throw new Meteor.Error('invalid-post', "this new post have invalid postType!");
        }
    ...
    postUpdate: function(currentPostId, postAttributes) {
        ...
        if (postAttributes.postType === 0) { /* for topics */
            ...
            throw new Meteor.Error('invalid-post-update', "update post with an invalid postType!");
        }
        ...
        if (postWithSameId.votes > 10 || postWithSameId.commentsCount > 0) {
            throw new Meteor.Error('invalid-post-update', "this post has already been voted or commented!");
        }

        if (postWithSameId.postType === 1
            && (postWithSameId.positiveCount > 0 || postWithSameId.negativeCount > 0)) {
            throw new Meteor.Error('invalid-post-update', "this debate has already been fired!");
        }
